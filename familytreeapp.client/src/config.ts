...
export const FRONTEND_LOGIN_URL = `${FRONTEND_BASE_URL}${ROUTE_PATH_LOGIN}`;
export const ROUTE_PATH_REGISTER = "/register";
export const FRONTEND_REGISTER_URL = `${FRONTEND_BASE_URL}${ROUTE_PATH_REGISTER}`;
export const ROUTE_PATH_ACTIVATE_USER = "/auth/activate/:userId/:token";
export const FRONTEND_ACTIVATE_USER_URL = `${FRONTEND_BASE_URL}${ROUTE_PATH_ACTIVATE_USER}`;
export const ROUTE_PATH_PASSWORD_RECOVERY = "/password-recovery"
export const FRONTEND_PASSWORD_RECOVERY_URL = `${FRONTEND_BASE_URL}${ROUTE_PATH_PASSWORD_RECOVERY}`;
export const ROUTE_PATH_PASSWORD_RESET = "/password-reset/:token";
export const FRONTEND_PASSWORD_RESET_URL = `${FRONTEND_BASE_URL}${ROUTE_PATH_PASSWORD_RESET}`;
